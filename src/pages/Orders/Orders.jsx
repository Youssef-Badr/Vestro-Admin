...
<div className={`flex flex-col gap-6 mt-12 mb-8 p-8 rounded-[2.5rem] border transition-all duration-500 ${darkMode ? 'bg-[#0D0D0D] border-white/[0.08] shadow-2xl' : 'bg-white border-black/10 shadow-sm'}`}>
